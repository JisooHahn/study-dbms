...
Options_ForceFolderPermissions_Tooltip=osu! 폴더에 읽기/쓰기 권한을 부여합니다 (비스타에서 UAC가 켜져 있을 때 유용).\n시간이 조금 걸릴 수 있습니다.
Options_Graphics_Combo=콤보 버스트
Options_Graphics_Combo_Tooltip=특정 콤보에 도달 할 때마다 화면 옆에서 콤보 버스트 이미지가 등장합니다.
Options_Graphics_CustomResolution=사용자 정의
Options_Graphics_ResolutionBorderless=(전체 화면)
Options_Graphics_Detail=세부 설정
Options_Graphics_DirectX_Tooltip=기본 렌더링 방식입니다.\n좀 더 좋은 효과를 연출하기 위해 쉐이더를 사용합니다. 그러나 일부 저사양 PC에서 올바르지 않은 작동 결과를 가져올 수 있습니다.\n일반적으로 문제가 없으면 이 옵션을 사용하는 것을 권장합니다.
Options_Graphics_Fire=콤보 파이어
Options_Graphics_Fire_Tooltip=30콤보 이상 확보 및 유지 했을때 화면 밑에서 불꽃 효과가 발생합니다.\n이 효과는 그래픽 카드가 픽셀 셰이더 2.0을 지원해야 적용됩니다.\n그래픽 카드가 이를 지원하지 않을 경우, 이 설정은 자동으로 해제됩니다.
Options_Graphics_FpsCounter=FPS 카운터 보기
Options_Graphics_FpsCounter_Tooltip=화면 오른쪽 아래에 FPS 카운터를 표시합니다.
Options_Graphics_LowEnd_Tooltip=그래픽에 의한 렉이 심할 때만 사용하세요. 이 옵션은 모든 osu!의 그래픽 효과를 끕니다.\n이것은 가끔씩 일어나는 렉을 제거해주지는 못합니다.\n그 렉은 컴퓨터의 하드디스크 또는 CPU를 사용하는 다른 프로세스에 의해 발생합니다.
...
Options_Graphics_Fullscreen_Tooltip=전체 화면 모드를 활성화하고 osu!가 화면 전체를 사용하게 하려면 활성화하세요.\n윈도우 7 이상에서 커서 지연 속도를 개선할 수 있습니다.
Options_Graphics_HitLighting=히트 라이트닝
Options_Graphics_HitLighting_Tooltip=친 노트 뒤에 게임 필드를 밝게 비추는 희미한 빛을 넣습니다.
Options_Graphics_Language=언어
Options_Graphics_LowEnd=저사양 PC
Options_Graphics_OpenGl_Tooltip=크로스 플랫폼 렌더링 방식입니다. 오직 심한 렉이나 낮은 FPS를 경험하고 있을 때, 혹은 쉐이더를 지원하지 않을 때만 권장합니다.
...
Options_Graphics_Shader_Tooltip=특수효과(반짝임, 번짐 등)를 연출하기 위해 쉐이더를 활성화합니다.\n권장하는 옵션이지만 픽셀 셰이더 2.0을 지원하는 그래픽 카드가 필요합니다.\n그래픽 카드가 이를 지원하지 않을 경우, 이 설정은 자동으로 해제됩니다.
Options_Graphics_Snaking=움직이는 슬라이더
Options_Graphics_Snaking_Tooltip=슬라이더가 시작점부터 부드럽게 그리듯이 나타납니다.\n매우 좋지 않은 사양의 컴퓨터가 아닌 한 이 기능은 정상적으로 동작할 것입니다.
...
Options_Graphics_Video_Tooltip=플레이 중 배경 동영상을 재생합니다.\n동영상이 있는 비트맵에서 렉이 많이 발생한다면 이 기능을 꺼보세요.
Options_HeaderBlurb=osu!의 설정을 변경합니다.
Options_Input_ConfirmExit=게임 종료 전에 항상 확인 메시지 띄우기
Options_Input_ConfirmExit_Tooltip=예상치 못한 조작으로 osu!를 종료하는 것을 방지합니다. 이 기능을 꺼도 어떤 상황에서는 확인 메시지가 뜰 것입니다.
...
Options_Input_DisableWheel_Tooltip=플레이 중 마우스 휠을 통해 볼륨 조절과 게임 일시정지를 할 수 있습니다.\n이 옵션은 그 기능을 끕니다.
...
Options_Input_Tablet=태블릿PC OS 지원
Options_Input_Tablet_Tooltip=태블릿 PC 혹은 태블릿을 사용하고 있을 때 클릭이 제대로 작동하지 않는 경우 이 옵션을 활성화 해주세요.
Options_Input_Wii=Wii 리모컨/TaTaCon 드럼 사용
Options_Input_Wii_Tooltip=Wii 리모컨과 Wii 태고 드럼을 사용하도록 합니다.\n활성화하기 전에 먼저 Wii 리모컨을 블루투스로 페어링 하였는지 확인해주세요.
...
Options_Online_AllowPublicInvites_Tooltip=선택 해제시 멀티플레이 초대를 자신의 친구에게서만 받습니다.
Options_Online_ChatAudibleHighlight=이름이 언급되면 알림음 재생
Options_Online_ChatAudibleHighlight_Tooltip=누군가가 당신의 이름을 언급하면 알림음을 재생합니다.
Options_Online_ChatFilter=비속어 필터링
Options_Online_ChatFilter_Tooltip=특정 문화에 대해 무례하거나 어린 나이의 사람에게 유해한 단어를 걸러내려 시도합니다.
Options_Online_ChatHighlight=이름이 언급되면 알림 팝업 표시
Options_Online_ChatHighlight_Tooltip=누군가가 당신의 이름을 언급하면 플레이 중이라도 화면 하단에 알림팝업을 표시합니다.
Options_Online_ChatHighlights=채팅 하이라이트 단어 목록 (빈칸으로 구분)
Options_Online_ChatIgnoreList=채팅 무시 유저 목록 (빈칸으로 구분)
Options_Online_ChatIgnoreList_Tooltip=유저명 뒤에 @와 c, h, p를 쓰면, 각각 채팅, 하이라이트, 귓속말을 무시할 수 있습니다.\n무시할 유저명에 빈칸이 있으면 언더바로 바꿔주세요. 예) "GG Time" → "GG_Time"
Options_Online_ChatPrivateTabs=귓속말을 새 탭에 표시
Options_Online_ChatPrivateTabs_Tooltip=체크되어 있으면 새 탭에 귓속말을 받고, 그렇지 않으면 활성화된 탭에 귓속말을 받습니다.
Options_Online_ChatRemoveForeign=외국 문자 필터링
Options_Online_ChatRemoveForeign_Tooltip=표준 ASCII(영어) 범위를 벗어나는 모든 문자를 제거합니다.\n외국 문자 때문에 게임이 느려지는 사람에게 유용합니다.
Options_Online_ClickToLogin=클릭하여 로그인!
Options_Online_DisplayCityLocation=위치 정보(도시) 공유하기
Options_Online_DisplayCityLocation_Tooltip=기본적으로 다른 유저들은 당신의 국적만 볼 수 있지만, 이 기능을 활성화하면\n현재 접속한 지역까지 보이게 됩니다. 이 기능의 정확도는 제법 높습니다.
Options_Online_HideChat=플레이 중 채팅 창 자동으로 숨기기
Options_Online_HideChat_Tooltip=이 기능을 켜면 플레이 중에는 채팅 창이 자동으로 사라집니다.\n쉬는 구간이나 전주 중일 때는 다시 채팅 창이 보여집니다.
Options_Online_InGameChat=게임 내 채팅
Options_Online_Integration=통합
Options_Online_MsnIntegration=MSN Live 상태 표시와 통합하기
Options_Online_MsnIntegration_Tooltip=Windows Live Messenger에 현재 플레이하거나 듣고 있는 비트맵을 표시합니다.
...
Options_Online_ShowChatTicker_Tooltip=채팅 창이 숨겨져 있을 때 새 메시지를 화면 아래에 한 줄로 표시합니다.
...
Options_Online_YahooIntegration_Tooltip=야후 메신저에 현재 플레이하거나 듣고 있는 비트맵을 표시합니다.
Options_Online_LogPrivateMessages=귓속말을 자동으로 저장하기
Options_Online_LogPrivateMessages_Tooltip=귓속말로 주고받은 모든 대화를 자동으로 Chat 폴더에 텍스트 파일로 저장합니다.
Options_Online_BlockNonFriendPM=친구가 아닌 유저로부터의 귓속말 차단하기
Options_Online_BlockNonFriendPM_Tooltip=친구 목록에 등록되지 않은 유저로부터의 귓속말을 받지 않습니다.
Options_Online_BlockNonFriendPM_Toggle_On=이제 친구가 아닌 유저로부터의 귓속말을 받지 않습니다.
...
SongSelection_NoBeatmaps=비트맵이 하나도 없습니다! 최소 1개의 비트맵이나 음악 파일을 곡 저장 폴더에 넣고 실행해주세요.\n곧 osu! 웹사이트의 비트맵 다운로드 페이지가 열립니다.
...
SongSelection_RemovedFromFavouritesA=즐겨찾기 A에서 {0}을(를) 제거했습니다
SongSelection_RemovedFromFavouritesB=즐겨찾기 B에서 {0}을(를) 제거했습니다
SongSelection_RemovedFromUnplayedSongs={0}을(를) 플레이 한 것으로 표시했습니다.
SongSelection_RemoveFromFavouritesA=즐겨찾기 A에서 지우기
SongSelection_RemoveFromFavouritesB=즐겨찾기 B에서 지우기
...
SongSelection_TooltipHoverDelay=커서를 비트맵 위에 올려고 잠시 기다리면 해당 비트맵이 선택됩니다.
...
SongSelection_WarningDestroyChanges=최신 버전으로 갱신하면 비트맵에 관한 '모든' 개인 설정들이 지워집니다. 정말 갱신하시겠습니까?
SongSelection_WebAccess=이 비트맵의 웹페이지 열기
Bancho_ChatWarning=본 채널에서는 영어만 사용 가능합니다. 다른 언어는 되도록 쓰지 마시기 바랍니다.
Bancho_NoFriendPMBlocked={0}님은 친구가 아닌 유저로부터의 귓속말을 받지 않고 있습니다!
Options_Input_Joystick=조이스틱 활성화
Options_Input_Joystick_Tooltip=osu!mania 모드에서 조이스틱이나 컨트롤러를 사용할 수 있도록 합니다.
...
ModSelection_Mod_Perfect=SS가 아니면 죽음을!
ModSelection_Mod_DoubleTime=빨라아아아아아아아!!
ModSelection_Mod_Nightcore=꺄아아아아아아아아!!
ModSelection_Mod_Hidden=어프로치 서클이 사라지고 노트가 보였다 사라집니다. 이 모드를 켜면 점수에 배수가 붙습니다.
...
ModSelection_Mod_Relax_Taiko=안심하세요! 불쑥불쑥 나타나는 스피너, 드럼롤, 캇에 신경쓸 필요가 없습니다.\n** 랭크되지 않습니다 **
ModSelection_Mod_SpunOut=스피너가 자동으로 돌아갑니다.
ModSelection_Mod_Autoplay=자동으로 연주되는 완벽한 플레이를 감상하세요.
MenuTip_1=새로운 osu! 비트맵을 추가하려면, 간단하게 .osz 파일을 게임화면으로 드래그하여 넣거나, 그 파일을 탐색기에서 더블클릭하거나, 다운로드 받는 브라우저에서 "열기"를 선택하면 됩니다.
MenuTip_2=비트맵이 많을 경우 좌/우 마우스 버튼으로 비트맵 목록을 위/아래로 드래그 해서 간편하게 원하는 비트맵을 찾아 볼 수 있습니다.
MenuTip_3=어디서든 F8/F9를 눌러 osu! 채팅에 참여할 수 있습니다!
MenuTip_4=선곡 화면에서 비트맵을 우클릭하거나 "비트맵 옵션" 메뉴를 눌러서 비트맵 관리 메뉴를 열 수 있습니다.
MenuTip_5=만약 게임이나 마우스가 버벅거리는 현상이 있다면 설정에서 프레임 제한을 조절해 보세요! 도움이 될지도 모릅니다!
MenuTip_6=빠른 콤보를 칠 때, 마우스의 좌/우 버튼을 번갈아 가며 누르거나, 키보드 Z/X 키를 사용해보세요.
MenuTip_7=만약 동영상이 재생되지 않는다면, 버그 리포트를 올리기 전에 FAQ를 읽어 주세요!
MenuTip_8=F12를 눌러서  osu! 내에서 스크린샷을 찍을 수 있습니다.
MenuTip_9=다른 유저의 플레이를 관전하고 싶다면 관전 모드를 이용하세요. F9 키를 누르면 나타나는 확장 채팅 인터페이스에서 이 기능을 사용할 수 있습니다.
MenuTip_10=비트맵이 업데이트 되었다면, 온라인상에 있는 한 옛 버전의 비트맵을 업데이트 하는 버튼이 활성화될 것입니다.
MenuTip_11=위키에는 다양하고 유익한 정보들이 있습니다. 꼭! 읽어보세요.
MenuTip_12=새로운 비트맵을 추가하기 위한 손쉬운 방법으로 osz 파일을 더블클릭으로 실행하거나, osu! 게임 화면에 드래그하여 넣으면 된다는 사실을 알고 계신가요?
MenuTip_13=온/오프라인 상태에 상관없이 결과 화면 창에서 F2를 눌러 리플레이 파일을 추출할 수 있습니다.
MenuTip_14=만약 당신이 생각하는 박자보다 조금 빠르거나 늦게 쳐야 맞는다고 느껴진다면, 옵션에서 오프셋 설정을 조절해 보세요.
MenuTip_15=원하는 비트맵을 찾는 가장 간편한 방법은 선곡 화면에서 제목이나 아티스트, 제작자 등의 일부를 입력해서 검색하는 것입니다.
MenuTip_16=채팅 창은 기본적으로 플레이 중에 자동으로 닫히도록 설정되어 있습니다. 채팅 창이 열려 있을 때 오른쪽 하단에 있는 토글 버튼을 찾아 보세요.
MenuTip_17=플레이 중에 마우스 휠을 굴려 음량을 조절할 수 있습니다. 원하지 않는다면 설정에서 이 설정을 끌 수도 있습니다.
MenuTip_18=플레이 중에 마우스 휠 버튼을 누르면 빠르게 일시정지할 수 있습니다. 원하지 않는다면 설정에서 이 설정을 끌 수도 있습니다.
MenuTip_19=선택된 비트맵의 웹페이지는 점수 목록 위의 말풍선 모양 버튼을 눌러서 빠르게 접속할 수 있습니다.
MenuTip_20=새로운 스킨들로 osu!를 꾸며보세요! 스킨은 스킨 포럼에서 다운로드 받을 수 있습니다.
MenuTip_21=F8로 채팅 창을 열거나 닫습니다. 채팅 창에서 쓸 수 있는 명령어는 !help 나 /help 를 입력하면 확인할 수 있습니다.
MenuTip_22=자주 쉬어가면서 하세요. 당신의 손은 osu!에서 스피너를 돌리는 시간 이상으로 당신을 위해 평생을 봉사할 테니까요.
MenuTip_23=랭크되지 않은 맵들을 무시하지 마세요. 만약 도움이 되는 조언을 남긴다면 그 맵이 랭크되는 데 큰 도움이 될지도 모릅니다.
MenuTip_24=멀티플레이어 모드에서 다른 플레이어들과 함께 비트맵을 플레이할 수 있습니다.
MenuTip_25=다른 플레이어에 대해서 궁금하신가요? F9를 눌러 그 유저의 패널에 마우스를 가져가 보세요!
MenuTip_26=선곡 화면에서 F5를 눌러 비트맵 목록을 갱신하고 새로운 비트맵을 불러올 수 있습니다.
MenuTip_27=게임 내 어디서든지 Shift+F12를 누르면 스크린샷을 찍은 뒤 자동으로 웹에 업로드됩니다.
MenuTip_28=설정 > 입력 장치에서 osu!에서 사용되는 키를 원하는 대로 설정할 수 있습니다.
MenuTip_29=비트맵 검색에 특별한 조건을 사용할 수 있습니다. 예: "ar>8 od=9" 지원되는 키워드: ar, od, hp, cs, bpm, stars, length, drain
MenuTip_30=Ctrl+R를 누른 채로 잠시 있으면 빠르게 재시작할 수 있습니다!
User_Filter_All=전체
User_Filter_Friends=친구들
User_Filter_Near=인근 지역
User_Filter_Country=국가별
OsuIsAngry=배경 그림을 지우면 osu!는 정말 화납니다!!!!!\n배경 밝기를 대신 조절하세요.
FunSpoiler_PlayFirst=모든 설정을 사용하기 위해서는 이 비트맵을 최소 한 번은 클리어 하셔야 합니다.
...
BossKeyActivated_Tooltip=보스 키를 눌렀습니다. 이 키로 osu!를 숨길 수 있습니다. 이 메시지는 한 번만 보입니다.
...
Options_Language_Confirm=몇몇 오버레이(유저 리스트 등)의 언어변환을 위해 osu!를 다시 시작해야 합니다. 지금 다시 시작할까요?
...
Options_TabSkin_CustonKey=키보드나 조이스틱으로 해당하는 노트열에 지정할 키 또는 버튼을 눌러주세요.
...
AudioEngine_NoPermissions=osu!가 이 비트맵을 읽을 권한이 없습니다.\n해당 비트맵의 폴더 속성에서 강제로 권한을 설정해 주세요.
EditorTip_1=H키를 눌러 간단한 도움말을 보실 수 있습니다!
EditorTip_2=V키를 누르면 마지막 노트로 빠르게 이동할 수 있습니다 한번 더 누를 경우 곡의 끝 부분으로 이동합니다.
EditorTip_3=타이밍/BPM 설정은 매우 중요합니다! 잘못된 타이밍 설정은 비트맵을 만들 때 박자를 잡기 어렵게 할 뿐더러 플레이하기도 힘듭니다. 만약 도움이 필요하다면 비트맵을 등록시키고 포럼이나 #modreqs 채널에서 타이밍 체크를 요청해보세요.
EditorTip_4=거리 비례 스내핑(Distance Snapping)은 타임라인에 따른 간격을 정확하게 재어 노트 사이의 일정한 거리를 유지하는데 도움을 줍니다.
EditorTip_5=스피너를 과도하게 사용하지 마세요! 오토플레이 모드로 최소 1000점 이상의 보너스를 획득해야만 플레이 가능하다고 간주합니다.
EditorTip_6=도움이 필요하다면, 도오오와아아줘어어요!!! 라고 외치기 전에, FAQ를 읽어보세요. #modhelp 채널에서 질문을 하거나, 홈페이지의 Beatmap Help 포럼에 도움을 요청하세요.
EditorTip_7=비트맵이 어려워질수록 콤보를 길게 설정할 수도 있습니다. 다만 너무 길게 하지 않는 것이 좋습니다. 최대 15-18 콤보까지가 적당합니다.
EditorTip_8=서로 겹쳐있는 노트는 플레이 시 잘 보이지 않습니다. 에디트 모드에서는 확인이 힘들 수 있으니, F5키를 눌러 테스트 모드에서 확인하셔야 합니다!
EditorTip_9=만약 박자 다음으로 스피너를 넣는다면, 가능하면 최대한 멀리 넣음으로써 플레이어가 인식하는 시간을 벌 수 있습니다.
EditorTip_10=AiMod (Ctrl-Shift-A)를 사용하면 맵의 잠재적인 문제점을 찾아줍니다.
EditorTip_11=복사(Ctrl+C)와 붙여넣기(Ctrl+V)로 박자를 반복할 수 있습니다. 복사된 노트로 수평(Ctrl+H), 수직(Ctrl+J)으로 뒤집거나 회전(Ctrl+>, Ctrl+<)으로 재배치 해보세요!
EditorTip_12=비트맵의 특정 지점에 호루라기, 피니쉬, 박수 사운드를 넣어 흥미를 더하세요! 그러나 너무 많이 사용하면 오히려 악영향을 미칩니다.
EditorTip_13=비트맵을 플레이 하는 플레이어에게 휴식을 제공하기 위해 쉬는 시간을 넣어보세요! 일반적으로, 쉬는 시간은 40초에서 1분마다, 5초에서 15초 사이가 적당합니다. 그러나, 쉬는 시간은 노래에 맞춰서 설정해야 합니다.
EditorTip_14=비트맵을 좀 더 어렵게 만들고 싶다면, 가능한 많이 박자를 넣고, 느리고 빠른 슬라이더를 사용하고, 콤보를 길게 하고, 곡 설정에서 난이도를 변경해보세요.
EditorTip_15=비트맵을 좀 더 쉽게 만들고 싶다면, 곡 설정에서 난이도 설정을 줄이면서 기존 비트맵의 흐름과 핵심 리듬을 조절해 보세요.
EditorTip_16=슬라이더를 사용할 때 곡선을 아름답게 사용해보세요. 그리드 스내핑 기능은 곡선을 아름답게 만드는데 도움을 줍니다.
EditorTip_17=비트맵을 테스트 해보면, 찾지 못한 문제점을 알아내거나 향상시킬 수 있습니다.
EditorTip_18=화면 오른쪽 아래의 속도 조절 버튼(Ctrl + Up/Down)을 사용해보세요. 느리게 하면 노래의 오프셋과 타이밍을 결정할 수 있으며, 박자의 위치 선정을 더 쉽게 할 수 있습니다.
EditorTip_19=만약 박자를 완성한 후 타이밍 설정을 변경했다면, 설정에서 노트를 재배치하는 것을 잊지 마세요! 재배치하여도 어긋난 박자는 손수 맞춰주셔야 합니다.
EditorTip_20=어떤 노래들은, 노래의 특정한 부분에서 노래의 박자가 변경됩니다. 이럴 때에는, 타이밍 창에서 박자가 변경되는 부분에 다른 타이밍 지점을 추가하세요.
EditorTip_21=북마크 기능은 비트맵의 중요한 지점을 빠르게 옮겨다닐 수 있습니다. 화면 아래의 탐색 바에 마우스를 올리면, 북마크 버튼이 보입니다.
EditorTip_22=슬라이더를 만들 때, 두 개의 웨이포인트 사이에 다른 웨이포인트를 넣으면 슬라이더 모양을 매끄럽게 만들 수 있습니다. 만들어진 슬라이드 라인 위에서 Ctrl+왼쪽 클릭시 웨이포인트가 추가됩니다. 웨이포인트를 오른쪽 클릭하면 삭제됩니다.
EditorTip_23=너무 긴 스핀은 플레이어를 힘들게 만들고, 너무 짧은 스핀은 플레이어를 혼란에 빠트립니다. 스핀을 적당한 길이로 조정하고, 너무 많은 스핀을 사용하지 않도록 해보세요.
EditorTip_24=비트맵이나 타임라인에서 노트를 오른쪽 클릭하면 해당 노트는 지워집니다. 빈 공간을 오른쪽 클릭하면, 다음 박자는 새로운 콤보로 시작됩니다.
EditorTip_25=비트맵의 중요한 지점에 북마크를 지정해보세요. 예를들면 타이밍을 변경하거나, 쉬는 시간 다음이나, 노래의 시작 부분에 지정해보세요.
EditorTip_26=키보드의 J/K 키로 한박자 뒤로/앞으로 움직일 수 있습니다.
EditorTip_27=F5 키나 화면 아래의 'test' 버튼을 클릭하여 비트맵을 테스트 해보세요. 비트맵의 드레인 문제점이나 노트 위치 선정에 도움을 받을 수 있습니다. 마찬가지로, 노래의 특정한 부분을 연습 할 수도 있습니다.
EditorTip_28=타임라인에 마우스를 올려두고 Alt 키를 누르고 마우스 휠을 사용하면, 확대/축소를 할 수 있습니다. 또는, 타임라인에서 왼쪽의 +/- 버튼을 사용 할 수 도 있습니다. 이 기능은 박자를 보다 뚜렷하게 보이도록 도와줍니다.
EditorTip_29=만약 맵의 타이밍이나 박자를 알고싶다면, 오른쪽 구석 아래의 음악 속도를 (25%, 50%) 설정해보세요. 단축키는 키보드의 위/아래 키 또는 Ctrl + 위/아래 키입니다.
EditorTip_30=만약 비트맵을 포기하기로 결정했다면 걱정하지 마세요.\n포기한 비트맵은 일정한 시간이 지나면 자동으로 무덤(graveyarded)으로 옮겨집니다. 만약 비트맵을 다시 살리고 싶다면, 프로필에서 부활(Resurrect)을 클릭하시면 간단하게 되살아납니다!
EditorTip_31=모든 게임 요소들은 비트맵 별로 스킨을 적용할 수 있습니다. 스킨에서 사용되는 것과 같은 파일명을 사용하세요.
EditorTip_32=노트를 복사(Ctrl+C 또는 편집 메뉴)하면, 클립보드에 선택된 노트의 시간, 콤보 숫자가 입력됩니다. 이 기능은 포럼에 글을 쓰거나 모딩할 때 매우 편리합니다!
EditorTip_33=라이브 매핑(Ctrl-Tab)을 사용해보세요. 태고나 osu!mania의 키 설정대로 입력시 노트가 생성되므로 맵을 빠르게 만들 수 있습니다.
...
Options_UseSkinSamples_Tooltip=이 옵션을 사용하지 않는다면, osu!의 기본 히트사운드가 사용 됩니다.
Options_UseTaikoSkin=태고 모드에서 태고 스킨 사용
Options_UseTaikoSkin_Tooltip=태고 스킨이 있으면, 태고 모드를 플레이 할 때 항상 태고 스킨을 사용합니다.
...
MatchSetup_HitEscapeToLeave=ESC를 한 번 더 누르면 방에서 나갑니다.
...
MatchSetup_NeedsBancho=멀티플레이를 하려면 Bancho에 연결되어 있어야 합니다!
...
BanchoClient_ConnectingToBancho=Bancho에 연결 중...
BanchoClient_Connecting=연결 중...
BanchoClient_LoggingIn=로그인 중...
BanchoClient_ConnectionFailedWillKeepRetrying=연결 실패. 재시도 중.
BanchoClient_ConnectionFailedRetryingIn30s=연결 실패. 30초 후 재시도...
BanchoClient_Disconnected=연결 끊김
BanchoClient_AuthenticationFailed=Bancho 인증 실패. 메인 메뉴의 유저 패널을 클릭하여 유저명/비밀번호를 확인하세요.
BanchoClient_OldVersion=Bancho 연결 실패: 구 버전의 osu!를 이용하고 있습니다. 온라인 플레이를 하기 위해서는 업데이트가 필요합니다.
...
BanchoClient_BanchoRestart=Bancho가 다시 시작 중입니다. 잠시만 기다려주세요...
BanchoClient_WelcomeToBancho=Bancho에 오신 것을 환영합니다!
BanchoClient_CommandHelp=서버 명령어 알림은 !help, 클라이언트 명령어 알림은 /help 를 입력하세요.
BanchoClient_Behaviour=나쁜 행동(스팸/모욕/욕설)을 발견했다면, !report <유저명> <사유>를 입력하여, 운영진에게 연락하세요.
BanchoClient_ConnectionTimedOut=접속 시간이 초과됨...
BanchoClient_WelcomeUser={0}님, osu!Bancho에 오신 것을 환영합니다!
...
Score_ErrorBeatmap=오류: 이 비트맵은 온라인 랭킹을 사용할 수 없습니다. 등록 상태가 변경 되었을 수 있습니다.
Score_ErrorDisabled=오류: 이 모드는 현재 사용할 수 없습니다. 자세한 사항은 osu! 공식 홈페이지를 확인하세요.
Score_ErrorVersion=오류: 현재 사용하시는 osu!의 버전이 너무 오래되어 점수를 등록할 수 없습니다! 업데이터를 실행해주세요.
...
InputManager_MouseButtonsDisabledWarning=마우스 클릭이 비활성화되어 있습니다. {0}를 누르면 다시 활성화할 수 있습니다.
...
ChatEngine_LockPanels_Tooltip=유저 패널의 움직임이 멈춥니다. 이 설정을 켜면 새로운 유저가 나타나지 않습니다.
...
ChatEngine_SilenceNotification=당신은 {0}분 동안 말할 수 없습니다. 자세한 정보는 프로필을 확인하세요.
...
ChatEngine_Help4=귓속말을 시도하는 유저에게 보낼 "다른 용무 중" 같은 메세지를 설정합니다. 빈칸으로 두면 취소합니다.
ChatEngine_Help5=Bancho에게 메시지를 보냅니다. (예: WHERE <닉네임>)
...
ChatEngine_Help12=3인칭으로 행동을 표현합니다.
...
ChatEngine_CloseTab=이 탭을 닫으려면 /close를 입력하세요.
...
BeatmapImport_FullProcess=비트맵 목록을 다시 작성합니다.\n이 작업은 몇 분의 시간이 소요될 수 있습니다.\n계속할까요?
BeatmapImport_Importing={0} 불러오는 중
BeatmapImport_FileInUse={0} 파일을 이동할 수 없습니다. 이 파일이 다른 프로세스에서 사용 중일 수 있습니다.
BeatmapImport_FileCorrupt=비트맵 파일이 손상되었거나 미완성입니다. Failed 폴더로 옮깁니다.
Options_Graphics_Storyboards=스토리보드
Options_Graphics_Storyboards_Tooltip=비트맵의 배경에 스토리보드를 표시합니다.\n스토리보드는 이야기성 요소, 가사, 특별 효과 등이 들어가 있습니다.
Options_Audio_IgnoreBeatmapSamples=모든 비트맵의 히트사운드 무시
Options_Audio_IgnoreBeatmapSamples_Tooltip=커스텀 히트사운드를 사용하지 않도록 게임 설정을 초기화 합니다. 게임 플레이중 소리가 이상할 수도 있습니다.
Options_TabSkin_IgnoreBeatmapSkins=모든 비트맵의 스킨 무시
Options_TabSkin_IgnoreBeatmapSkins_Tooltip=비트맵 스킨을 사용하지 않도록 게임 설정을 초기화 합니다.
Options_Online_AutomaticDownload=osu!direct 다운로드를 자동으로 시작
Options_Online_AutomaticDownload_Tooltip=관전을 하거나 멀티플레이시 자동으로 비트맵을 다운받습니다.
Options_Online_AutomaticDownloadNoVideo=동영상 없는 비트맵 선호
Options_Online_AutomaticDownloadNoVideo_Tooltip=osu!direct에서 자동으로 다운로드 할 때 비디오 포함 여부를 선택합니다.
...
CollectionDialog_ImportSuccess=컬렉션에 맵 {0}개를 불러왔으나 {1}개의 맵은 불러오는데 실패했습니다.
...
Options_Input_ConfineMouseToFullscreen_Tooltip=전체 화면 모드에서 빠른 전환을 사용해 마우스를 다른 모니터로 옮겨도 osu! 창 내에는 커서가 남아 있게 됩니다.
Options_Input_ConfineMouse=마우스 커서 영역제한
Options_Input_ConfineMouse_Fullscreen=전체화면에서만
Options_Input_RawInput=직접 입력 사용
Options_Input_RawInput_Tooltip=직접 입력은 운영체제의 마우스 설정을 무시하고 마우스의 움직임을 장치로부터 직접 받아들이며, 가장 안정적이고 정확한 마우스 움직임을 제공합니다.\n(단, 마우스 드라이버 설정에는 영향을 받습니다.)
Options_Input_RawInputPoll=직접 입력 사용 (보고율: {0}/초 지연시간: {1})
Options_Input_RawInputFailed=마우스 직접 입력 초기화 실패.
Options_Input_RawInputRequired=윈도우 8.1 이상에서 마우스 속도 조절을 위해 마우스 감도를 변경하신 것을 감지했습니다. 윈도우 자체 변경점 때문에 이 기능을 사용하시려면 직접 입력을 사용해야 합니다. 자동으로 직접 입력을 사용하도록 설정했습니다.
Options_Input_RawInputSuggested=직접 입력을 사용할 수 있는 장치를 PC에 연결하셨습니다. 자동으로 직접 입력을 사용하게 했습니다.
SkinManager_ErrorLoadingConfig=현재 스킨의 설정 파일(skin.ini)을 읽는 중 문제가 발생하였습니다. 문제 확인 후 고쳐주세요.
...
Options_Language_Font_Override_Tooltip=덜 화려한 글꼴을 선호하시는 분들을 위해 Tahoma를 채팅 창의 글꼴로 사용합니다.
...
AIComposeMania_TooManyNotes=동시에 6개 이상의 노트는 허용되지 않습니다.
AIComposeMania_StackedObjects=이 노트는 다른 노트 위에 겹쳐 있습니다.
AIComposeMania_OverlappingObject=이 노트는 다른 노트의 궤도 위에 겹쳐 있습니다.
AIMetaMania_EasyHpBelow4=이지와 노말의 HP Drain Rate는 4 이하를 추천합니다.
AIMetaMania_HardHpBelow7=하드와 그 이상의 난이도에는 HP Drain Rate를 적어도 7, 또는 그 이상을 주는 것을 권장합니다.
AIMetaMania_VeryLowSliderOdBelow8=슬라이더가 굉장히 적은 맵은 적어도 Overall Difficulty 8을 권장합니다.
AIMetaMania_LowSliderOdBelow7=슬라이더가 적은 맵은 적어도 Overall Difficulty 7을 권장합니다.
AIMetaMania_OdBelow5=Overall Difficulty는 적어도 5를 권장합니다.
AIMetaMania_NoManiaLetterbox=매니아 모드에서 Letterbox는 허용되지 않습니다.
AIMetaMania_NoManiaCountdown=매니아 모드에서 Countdown은 허용되지 않습니다.
AITimingMania_NoManiaBreaktime=매니아 모드에서 브레이크 타임은 추천하지 않습니다.
AITimingMania_TooManySpeedChanges=이지/노말 난이도에 변속이 너무 많습니다.
AICompose_ObjectsTooClose=이 두 노트는 10ms보다 더 적게 떨어져 있습니다!
...
AICompose_ShortSpinner=이 스피너는 너무 짧습니다. 오토플레이가 반드시 보너스 점수 1000점 이상을 얻을 수 있어야 합니다.
...
AIDesign_BackgroundTooLarge=배경 이미지가 1366x768보다 큽니다.
AIDesign_VideoDimensionsTooLarge=4:3 비디오는 크기가 1024x768을 넘어서는 안됩니다.
AIDesign_VideoDimensionsTooLargeWidescreen=16:9 비디오는 크기가 1280x720을 넘어서는 안됩니다.
AIDesign_EpilepsyWarning=이 맵은 스토리보드가 자주 변화함으로 광과민성 발작 경고(Epilepsy warning)가 필요할 수 있습니다.
AIDesign_FileMissing=해당 파일 없음:
AIDesign_IncorrectDimensions={0}의 크기는 반드시 {1}x{1}이여야 합니다.
AIMapset_ConflictingArtist=Artist가 {0} 난이도와 다릅니다.
AIMapset_ConflictingTitle=Title이 {0} 난이도와 다릅니다.
AIMapset_ConflictingUnicodeArtist=Unicode artist이 {0} 난이도와 다릅니다.
AIMapset_ConflictingUnicodeTitle=Unicode title이 {0} 난이도와 다릅니다.
AIMapset_ConflictingSource=Source가 {0} 난이도와 다릅니다.
AIMapset_ConflictingTags=Tags가 {0} 난이도와 다릅니다.
AIMapset_ConflictingAudioFile=오디오 파일이 {0} 난이도와 다릅니다.
AIMapset_ConflictingLeadin=Audio lead-in이 {0} 난이도와 다릅니다.
AIMapset_ConflictingPreviewTime=Audio Preview time이 {0} 난이도와 다릅니다.
AIMapset_ConflictingCountdown=Countdown이 {0} 난이도와 다릅니다.
AIMapset_ConflictingLetterbox=휴식 중 삽입되는 Letterbox가 {0} 난이도와 다릅니다.
AIMapset_MissingStandardDiff=해당 맵셋에는 2개 이상의 보통 난이도가 필요합니다.
AIMapset_MissingEasierDiff=해당 맵셋에는 1개 이상의 이지/노말 난이도 필요합니다.
AIMapset_MissingTaikoDiff=해당 맵셋에는 2개 이상의 태고 난이도가 필요합니다.
AIMapset_MissingManiaDiff=해당 맵셋에는 2개 이상의 매니아 난이도가 필요합니다.
AIMapset_LargeFilesize=비디오를 포함치 않는 맵셋의 파일 크기가 10MB를 초과했습니다.
AIMapset_LargeFilesizeVideo=비디오를 포함한 맵셋의 파일 크기가 24MB를 초과했습니다.
AIMeta_RomanizedArtistUnicode=Romanised artist에 유니코드 문자가 포함되어 있습니다.
AIMeta_RomanizedTitleUnicode=Romanised title에 유니코드 문자가 포함되어 있습니다.
AIMeta_IncorrectStackLeniency=Stack leniency 값이 0.9보다 크거나 0.3보다 작습니다.
AITiming_BeatmapTooLong=비트맵이 6분 이상입니다. 마라톤 스타일 맵이 아닌 이상 줄이시는 것을 권장합니다.
AITiming_BeatmapTooShort=비트맵이 45초보다 짧습니다. 보다 길게 하는 것을 권장합니다.
AITiming_Mp3LongerThanMap=맵에 사용된 mp3 파일의 길이가 매핑이 된 부분보다 깁니다. 자르거나 파일 크기를 줄이시는 것을 권장합니다.
AITiming_OverlappingTimingPoints=타이밍 지점 두 개가 같은 지점에 있습니다.
AITiming_UnsnappedKiai=Kiai가 스냅되어 있지 않습니다.
AITiming_KiaiTooShort=Kiai가 15초 이내에 켜진 후 꺼졌습니다.
AITiming_UnsnappedKiaiEnd=Kiai가 끝나는 구간이 스냅되어 있지 않습니다.
AITiming_AllTimingSectionsQuiet=모든 타이밍 구간이 5%보다 적은 볼륨을 가지고 있습니다.
AITiming_SomeTimingSectionsQuiet={1}중의 {0} 타이밍 구간이 5%보다 적은 볼륨을 가지고 있습니다.
AITiming_TooMuchKiai=맵의 1/3 이상이 kiai가 켜져 있습니다. 줄이시는 것을 권장합니다.
AITiming_TooMuchKiaiTvSize=TV Size 맵의 1/2 이상이 Kiai가 켜져 있습니다. 줄이시는 것을 권장합니다.
AITiming_NoPreviewPoint=이 맵의 Preview point가 설정되어 있지 않습니다. 상단의 타이밍 메뉴에서 설정하시는 것을 권장합니다.
AITiming_NoKiaiEnd=Kiai는 끝나는 부분이 필요합니다.
AITiming_LowAudioBitrate=오디오 비트레이트가 128kbps보다 낮습니다. 더 좋은 음질의 파일을 찾아보시는 것을 권장합니다.
AITiming_HighAudioBitrate=오디오 비트레이트가 192kbps보다 높습니다. CBR 192kbps 또는 VBR ~1.0으로 재압축 하시는걸 권장합니다.
AIMetaTaiko_NoLetterboxTaiko=태고 모드에선 Letterbox를 허용하지 않습니다.
AIMetaTaiko_NoEpilepsyTaiko=태고 모드에선 광과민성 발작 경고(Epilepsy warning)를 허용하지 않습니다.
AIMetaTaiko_NoCountdownTaiko=태고 모드에선 Countdown을 허용하지 않습니다.
AIMetaTaiko_BadSvTaiko=태고 모드에서의 슬라이더 속도는 1.4 또는 1.6이여야 합니다.
AITimingTaiko_KiaiToggledTooOften=Kiai가 너무 자주 켜졌다 꺼졌다 합니다.
...
Options_Editor_DefaultSkin_Tooltip=에디트 중 커스텀 스킨을 무시합니다. 에디트 중에는 겹침 등등을 체크하기 위해서 기본 스킨 사용을 권장합니다.
Options_Editor_NoUndo=되돌리기 기능 비활성화
Options_Editor_NoUndo_Tooltip=정말 긴 마라톤 맵을 매핑할 때에는 되돌리기, 다시 실행 기능으로 큰 문제가 발생할 수 있습니다. 극단적인 상황에서만 사용하세요.
Options_Editor_Snaking_Sliders=움직이는 슬라이더
Options_Editor_Snaking_Sliders_Tooltip=에디터에서 슬라이더가 시작점부터 부드럽게 그리듯이 나타납니다.
...
BeatmapManager_NewBeatmapDetected=새로운 비트맵을 찾았습니다. F5를 눌러 새로고침 해주세요.
BeatmapManager_SongsFolderChanged=Songs 폴더에서 변화가 감지되었습니다. F5를 눌러 새로고침 해주세요.
...
AudioEngine_NoCompatibleAudioDevice=오디오 장치가 감지되지 않았습니다. osu!를 플레이 하기 위해 알맞는 오디오 장치를 설치해주세요.
...
Options_SongSelect_Thumbnails_Tooltip=각 비트맵의 배경을 미리 보여줍니다. (2.2버전 이상)
AIComposeMania_HoldNoteTooShort=이 롱노트는 10ms보다 짧습니다!
...
BeatmapSubmissionSystem_AlreadyRanked=해당 비트맵은 이미 랭크되어 있어 업데이트 할 수 없습니다.
BeatmapSubmissionSystem_InGraveyard=이 비트맵은 현재 무덤(Graveyard)에 있습니다.
BeatmapSubmissionSystem_UngraveyardMap=프로필의 비트맵 카테고리에서 비트맵을 부활시킬 수 있습니다.
...
BeatmapSubmissionSystem_AvailableUploadCount=새로운 비트맵을 업로드합니다, 앞으로 비트맵 {0}개를 더 업로드 할 수 있습니다.
...
BeatmapSubmissionSystem_CreatorsWords=이 빈 공간에 맵 설명을 쓰세요. 모드 받을 때 유리할 수 있습니다!
BeatmapSubmissionSystem_UploadFailed=비트맵을 업로드 할 수 없습니다.
BeatmapSubmissionSystem_BeatmapTooLarge=비트맵의 용량이 너무 큽니다, 만약 배경 영상이 있다면 다시 인코딩하여 파일 용량을 줄여주세요.
...
BeatmapSubmissionSystem_Designer_CheckGuidelines=가이드라인을 잘 따랐는지 확신이 서지 않으시나요?\n이 곳을 한 번 확인하시고 비트맵 랭크를 위해 힘내주세요.
BeatmapSubmissionSystem_Designer_BeatmapRankingCriteria=Beatmap Ranking Criteria
BeatmapSubmissionSystem_Designer_OneStepFromSharing=세계에 당신의 비트맵을 공개하기까지 단 한 단계 남았습니다!
...
BeatmapSubmissionSystem_Designer_LoadInBrowserAfterSubmission=제출 후 비트맵 스레드 열기
...
Options_Online_AutoNP_Tooltip=#spectator 채널에 관전자가 있는 경우, 현재 플레이 하고 있는 비트맵의 링크를 자동으로 표시합니다.
...
EditorModeCompose_InsertBreakTooltip=현재 위치에 브레이크 타임을 설정하려면 이 곳을 클릭하세요. 두 노트 사이에 위치하여야 하며 브레이크 타임의 길이는 자동으로 설정됩니다.
EditorModeCompose_ComposeToolSelectTooltip=이미 놓여진 노트들을 선택 및 수정합니다.\nCtrl+클릭: 여러 노트를 선택할 수 있고, 슬라이더에 점을  추가할 수 있습니다.\n오른쪽 클릭: 노트와 점을 제거합니다.
EditorModeCompose_ComposeToolCircleTooltip=왼쪽 클릭: 노트를 배치합니다.\n오른쪽 클릭: 새 콤보를 시작하거나 노트를 삭제합니다. (일시정지)
EditorModeCompose_ComposeToolSliderTooltip=왼쪽 클릭: 슬라이더를 시작하거나, 현재 슬라이더에 점을 넣습니다.\n오른쪽 클릭: 슬라이더에 점을 제거하거나, 슬라이더를 끝냅니다.\n왼쪽 클릭을 이용하여 같은 위치에 점을 두 번 찍으면 베지어 곡선에 위에 새로운 곡선을 그릴 수 있습니다.
...
EditorModeCompose_GridSnapTooltip=서클들은 기본적으로 격자판 위에 배치됩니다.\n단축기: Shift를 눌러 토글, T\nCtrl을 계속 눌러 임시로 비활성화 할 수 있습니다.
EditorModeCompose_DistanceSnapTooltip=박자를 기반으로 하여 연속 서클들 사이의 거리를 조절하여 배치합니다.\n단축기 : Alt로 토글, Y\nAlt+ 마우스 휠은 스내핑된 노트들을 조정시킵니다.\nAlt를 계속 누르면서 상단에 있는 슬라이드 바를 드래그하면 스내핑된 배수를 바꿀 수 있습니다.
EditorModeCompose_NoteLockTooltip=현재 선택한 노트에 시간과 위치는 바꾸지 않으면서 히트사운드를 적용하실 수 있습니다.\n노트에 'L' 키를 누르세요.
EditorModeCompose_SelectNotesMessage=먼저 노트를 선택하세요!
EditorModeCompose_NotEnoughRoomMessage=브레이크 타임을 넣을 공간이 부족합니다! 두 노트 사이의 공간을 충분히 확보해 주세요.
EditorModeCompose_8WarningMessage=숙련된 사람이 아니라면 1/8 박자 간격을 사용하시는 것은 추천드리지 않습니다. 만일 사용하게 되었다면, 비트맵 질문 포럼과 채팅을 이용하여 비트맵의 타이밍에 대해 다른 사람들에게 도움을 요청하세요!
EditorModeCompose_3WarningMessage=1/3 박자를 사용하면 BPM을 3부분으로 나누어 노트를 생성할 수 있습니다. 음악적 측면에서, 이것은 복잡한 타이밍입니다. 확실치 않다면, 이 박자를 쓰기 전에 타인에게 질문해 주세요.
EditorModeCompose_6WarningMessage=1/6 박자를 사용하면 BPM을 3부분으로 나누어 노트를 생성할 수 있습니다. 음악적 측면에서, 이것은 복잡한 타이밍입니다. 확실치 않다면, 이 박자를 쓰기 전에 타인에게 질문해 주세요.
EditorModeCompose_16WarningMessage=1/{0} 박자는 그 누구에게나 사용하는 것을 추천하지 않습니다!!!
EditorModeCompose_LiveMappingDisabled=라이브 매핑 비활성화됨
EditorModeCompose_LiveMappingEnabled=라이브 매핑이 활성화되었습니다! 노래가 재생되는 동안 태고/매니아 맵에 키보드로 노트를 입력할 수 있습니다!
EditorModeCompose_DistanceSnapTooLarge=노트들끼리 배치된 거리가 너무 멉니다.\n배치된 거리를 줄이거나 가장자리 부분을 줄여보세요.
EditorModeCompose_SelectedSampleReset=선택된 노트의 히트사운드가 초기화 됩니다.
EditorModeCompose_SampleApplied=샘플 적용됨
EditorModeCompose_SelectNoteBeforeSampleCopy=노트를 선택 후 Ctrl+C를 누르시면 노트가 복사됩니다.
General_Editor_ClipboardNotAvailable=클립보드에 접근할 수 없습니다 - 위치 텍스트를 사용할 수 없습니다.
EditorModeDesign_ErrorCopyingBackgroundFile=배경 화면 파일을 복사하는 도중에 오류가 발생하였습니다:
EditorModeDesign_ErrorDuringImportProcess=변환하는 도중 오류가 발생하였습니다. 이미지/비디오 파일을 osu!에서 읽지 못하는 경우일 수도 있습니다.
...
EditorModeTiming_ClickToFineTuneTooltip=타이밍 설정 패널을 사용하여 세밀하게 조정하시려면 클릭하세요.
EditorModeTiming_TimingMenuNote=주의: BPM을 변경하신 후 모든 노트를 \n타이밍 메뉴에서 재배치해야 합니다.
EditorModeTiming_HoldShiftForLargerChanges=길게 수정하시려면 Shift를 누르면서 클릭해 주세요.
EditorModeTiming_HoldCtrlForSmallerChanges=짧게 수정하시려면 Ctrl을 누르면서 클릭해 주세요.
General_DecreaseOffset=오프셋 내리기
General_IncreaseOffset=오프셋 올리기
General_Offset=오프셋
EditorModeTiming_TimingSetupTooltip=F6을 눌러 다중 타이밍 구간 미세조정을 사용해보세요.
EditorModeTiming_MoveAlreadyPlacedNotes=오프셋/BPM이 변경될 경우 배치되어 있는 노트 이동
EditorModeTiming_MoveAlreadyPlacedTooltip=이미 배치된 비트맵의 자잘한 조정시에만 이 옵션을 사용하세요.\n만약 비트맵이 배치되지 않았다면, 조정 전에 미리 꺼놓아야 합니다.
Editor_Timing_SliderVelocity=슬라이더 속도
Editor_Timing_SliderTickRate=슬라이더 틱 개수
EditorModeTiming_TapHere=이곳을 클릭!
EditorModeTiming_TapHereTooltip=많이 누를수록 타이밍이 정확해집니다.\n이 버튼을 클릭하거나 'T' 키를 사용하세요.
General_Reset=초기화
...
EditorControl_SnapNotesCurrentTimingWarning=모든 노트를 현재 타이밍 구간에 배치하시겠습니까?
EditorControl_OneSectionRequiredWarning=최소한 첫 구간의 시간은 맞춰주세요!
EditorControl_SnapAllNotesWarning=모든 노트를 모든 타이밍 구간에 배치하시겠습니까?
EditorControl_RecalculateSlidersMessage=BPM을 변경하신 후 슬라이더를 다시 조절 하시는 것을 추천합니다. 몇 개의 슬라이더들이 필요한 것보다 짧아질 수 있습니다.
General_File=파일
General_View=보기
Editor_Compose=에디터
Editor_Design=디자인
...
Editor_FileOperations_RevertFileToLastSavedState=마지막으로 저장된 지점으로 불러오시겠습니까?
Editor_FileOperations_SaveAsDialog=모든 노트를 지우고 새로 시작하시겠습니까?
Editor_FileOperations_SubmitDialog_1=비트맵을 제출하려면 로그인을 해야 합니다.
Editor_FileOperations_SubmitDialog_2=비트맵을 제출하기 전 한 개 이상의 노트가 배치되어 있어야 합니다.
Editor_FileOperations_UnusedFilesInDirectoryDialog=사용하지 않는 파일들이 비트맵 폴더에 남아있습니다! 삭제하시겠습니까?
Editor_FileOperations_LoadSelectionRequirement=선택된 것을 불러오기 위해서는 에디터 모드에 있어야 합니다!
Editor_FileOperations_InvalidFormat=파일 형식이 잘못되었습니다!
EditorControl_BeatmapMustBeSavedDialog=해당 작업을 수행하기 위해서는 반드시 비트맵을 저장하여야 합니다. 비트맵을 저장하시겠습니까?
...
HitObjectManager_LoadSave_StoryboardErrorOnLine_2=스토리보드 스크립트 {0}, 라인 {1}에서 오류 발생:\n{2}
HitObjectManager_LoadSave_StoryboardErrorContent_1=새 이벤트의 예상 시작점이 변형 타입입니다. (띄어쓰기나 밑줄 문자를 확인하셨습니까?)
...
HitObjectManager_LoadSave_FileAlreadyExistsDialog=메타데이터가 같은 파일이 존재합니다, 덮어씌우시겠습니까?
...
Options_ScaleManiaSpeedWithBPM=BPM을 기준으로 osu!mania 스크롤 속도 조절
Options_ScaleManiaSpeedWithBPM_Tooltip=스크롤 속도가 비트맵의 BPM에 따라 달라집니다.\n이 옵션을 켜면, BPM이 빠른 비트맵에서는 스크롤 속도도 빨라집니다.
...
BanchoClient_TournamentMatchReady=토너먼트 매치가 준비되었습니다. {0}초 후 자동으로 토너먼트 서버로 이동됩니다.
Options_OpenOsuFolder=osu! 폴더 열기
Options_ClientLocked=당신의 클라이언트는 부적절한 행위로 인해 잠겼습니다.\n위반 행위로 인한 잠김이 해제될 때까지 기다리세요.
...
Player_LocalBeatmapOffsetSet=비트맵 오프셋이 {0}ms로 설정됨
Player_WaitBeforePausing=다시 일시정지를 하려면 잠시만 기다려주세요.
Player_PressToViewReplay=F1을 눌러 리플레이 보기
...
BanchoClient_TournamentMatchFinished=토너먼트에 참여해주셔서 감사합니다. 잠시 후 공개 Bancho로 돌아갑니다.
...
Options_Gameplay_Hidden_Approach_Tooltip=때때로 히든 모드를 켜고 플레이할 때 첫 히든 노트를 언제 클릭할지 판단이 힘들 때가 있습니다.\n이 옵션을 켜면 첫 번째 히든 노트의 어프로치 서클을 보이게 해줍니다.
Options_Input_AbsoluteToOsuWindow=osu! 창에 직접 입력 사용
Options_Input_AbsoluteToOsuWindow_Tooltip=타블렛과 같은 절대 위치 입력 장치는 일반적으로 전체 화면 영역에 영향을 줍니다.\n이 설정은 타블렛 스크린 영역을 완전히 osu! 창에만 사용할 수 있게 합니다.
Options_Audio_Device=장치
Options_Audio_AudioDevice=출력 장치:
AudioEngine_NewDeviceDetected=새로운 오디오 장치가 발견되었습니다. 설정 메뉴에서 오디오 장치를 변경할 수 있습니다.
Options_TabSkin_SplitLayout=Co-op 배치
Options_TabSkin_BindAlternateSpecialKeys=다른 특수키 지정
ConfigManager_SongFolderNotFound=사용자 정의의 곡 저장 폴더를 찾을 수 없습니다. 기본값으로 복원합니다.
Update_Misc=기타
...
AIMapset_MissingCTBDiff=이 맵셋은 2개 이상의  캐치 더 비트 난이도가 필요합니다.
AIMapset_HardDiffRequired=이 맵셋은 Hard 난이도 없이 Insane 난이도를 가질 수 없습니다.
AIMapset_MapsetMissingDiff=이 맵셋은 해당 난이도가 없습니다: {0}
AIMapset_UninheritedTimingPointsConflictWithDiff=Uninherited timing points이 {0} 난이도와 충돌합니다.
BloomRenderer_InitializationFailed=번짐 효과 초기화에 실패했습니다 - 번짐 효과를 비활성화합니다.
BlurRenderer_InitializationFailed=흐림 효과 초기화에 실패했습니다 - 흐림 효과를 비활성화합니다.
...
GameBase_ResolutionChangeFailed=화면 해상도 변경에 실패했습니다. 모니터나 그래픽 카드가 이를 지원하지 않아 발생했을 수 있습니다.
Menu_NewFrameworkVersion=osu!가 .NET Framework v4로 전환되었습니다. osu!를 계속 실행하기 위해서는 시스템 업데이트가 필요합니다. 여기를 클릭하여 자세히 알아보세요.
GameBase_UpdateFailedFrameworkVersion=.NET Framework가 구버전으로 더 이상 osu! 업데이트를 지원하지 않습니다. 여기를 눌러 문제를 해결하세요!
Maintenance_DotNetInstall=Microsoft .NET Framework v4가 지금 설치됩니다...
Maintenance_WaitingForDotNetComplete=.NET Framework v4의 설치 완료를 기다리는 중...
Maintenance_DotNetFailed=.NET Framework v4를 설치할 수 없었습니다. 이곳을 클릭하여 직접 다운로드 받아 설치 하실 수 있습니다.
Options_Graphics_Letterboxing=레터박스 사용
Options_Graphics_Letterboxing_Tooltip=osu!를 전체 화면으로 띄우되 화면의 중앙 부분에만 작게 표시합니다. 작은 게임 해상도와 적은 지연시간을 원할 때 유용합니다.
Options_Graphics_LetterboxPositionX=수평 위치
Options_Graphics_LetterboxPositionY=수직 위치
Tournament_MessageRememberCredentials=옵션에서 \"아이디 저장\" 과 \"자동 로그인\" 이 체크 되어 있는지 확인해 주세요.
Tournament_ClientCouldNotConnect=대회 클라이언트에 연결을 할 수 없었습니다. 인터넷 연결을 확인해주세요.
Tournament_MessageNoAccess=대회 클라이언트에 접근할 권한이 없습니다. tournaments@ppy.sh에 문의해보세요.
Tournament_AnnotationText=주석 내용:
Tournament_BestOf=최대 승리 수:
Tournament_MakeAMultiplayerRoomWithFormat=다음 유형의 멀티플레이어 방 생성:
GameBase_UpdateFailedGlContext=지원하는 GL 렌더러를 얻을 수 없습니다. 그래픽카드 드라이버를 업데이트 하세요.\n\n여기를 클릭하여 더 많은 정보를 확인하세요.
ModSelection_Mod_Easy_OsuMania=전반적인 난이도를 줄여줍니다 - HP 감소량이 더 작아지고, 판정을 더욱 좋게 합니다.
...
ModSelection_Mod_Easy_Taiko=전반적인 난이도를 낮춰줍니다 - 노트가 느려지고, 판정을 더욱 좋게 합니다.
...
SongSetup_MetadataCannotBeSaved=비트맵이 현재 메타데이터와 함께 저장될 수 없습니다. 기존 메타데이터로 복귀합니다.
...
UserReportDialog_ReasonUnwantedContent=부적절한 컨텐츠 연결 (성인물, 공포물, 광고, 바이러스)
...
Options_FullscreenLatencyWarning=전체화면 모드를 켜지 않고 실행하면 입력 지연시간이 늘어날 수 있습니다!
Options_FullscreenCompatibilityWarning=전체화면 모드는 현재 호환 모드에서 사용이 불가능합니다.
BeatmapImport_OldPackFormat=오래된 비트맵 팩 형식이 감지되었습니다. 이런 경우 직접 팩을 추출해야 합니다.
GameBase_ErrorWhileProcessingFiles=파일 작업중에 에러가 검출되었습니다. IO.log 파일에서 자세한 내용을 확인할 수 있습니다.
Options_CompatibilityModeWarning=호환 모드는 전체적으로 입력 지연시간을 높이고 게임 성능을 떨어뜨릴 수 있습니다.
Options_CompatibilityModeForcedWarning=osu!가 강제적으로 호환 모드로 실행됩니다. 그래픽카드 드라이버를 업데이트하여 이 문제를 해결해보세요!
GameBase_DetectedBackgroundApp={0} 가 백그라운드에서 실행되고 있는 것을 감지했습니다. 이것은 osu! 성능에 부정적 영향을 줄 수 있습니다. 종료하는 것을 고려해보세요!
Options_DetectPerformanceIssues=성능 문제 감지
Options_DetectPerformanceIssues_Tooltip=osu!가 당신의 PC에서 게임 성능에 부정적 영향을 줄 수 있는 문제들을 능동적으로 파악하여 당신에게 알려줍니다. 
Player_MusicVolumeWarning=음악 볼륨이 0%로 설정되어 있습니다! 이곳을 클릭하여 복구하세요.
Options_ReduceDroppedFrames=프레임 안정화
Options_ReduceDroppedFramesTooltip=이 옵션을 켜면 사용자는 급격하게 하락하거나 불안정한 프레임을 규칙적으로 만들어 줍니다. 이 옵션은 약간의 프레임을 감소시킬 수 있습니다.
BanchoClient_PasswordReset=당신의 계정 비밀번호가 초기화 되었습니다. 이곳을 클릭하여 새 비밀번호를 설정하세요!
BanchoClient_Verification=온라인으로 플레이하려면 본인 인증을 해야합니다! 이곳을 클릭하여 진행하세요.
BanchoClient_PendingVerification=인증 대기 중...
SongSelection_DifficultyFilteredWarning=현재 비트맵들이 난이도에 의해 필터링 중입니다. \n이곳을 클릭하여 범위를 조정하세요.
DatabaseHelper_SaveFailed=데이터베이스 저장에 실패했습니다. runtime.log 파일을 확인하여 자세한 정보를 확인하세요.
Options_SkinPreview=게임 화면 미리 보기
BeatmapManager_ErrorWhileProcessing={0} 작업 중 오류 발생
Options_CompatibilityModeForcedOptimusWarning=호환 모드는 NVIDIA Optimus 시스템과 사용시 좋은 호환성을 보여줍니다.
Options_ShowChatMessageNotifications=채팅 메세지 알림 보이기
Options_ShowChatMessageNotificationsTooltip=새로운 채팅 메세지가 도착하면 알림을 보여줍니다.
